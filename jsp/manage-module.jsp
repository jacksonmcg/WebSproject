        ...
        <div class="card col-md-6 col-sm-12 col-lg-5 mt-4 py-3 shadow">
          ...
          <form action="updateModule.htm">
            ...
            <div class="row justify-content-center mt-1">
              <div class="row pt-3">
                <div class="col-6">
                  <button class="btn btn-sm ghost" type="submit" onClick="myFunction('${param.name}','${param.id}')">
...
<script>
function myFunction(mn2, id2)
{
    
    //I cannot find a way to pass through the two variables from a function to a scriptlet
    <c:set var="test1" value='mn2' scope="request" />
    <c:set var="test2" value='id2' scope="request" />

    <% 
        mn = (String)request.getParameter("test1"); 
        id = (String)request.getParameter("test2"); 

        String sql2;
        sql2 = "select module_name from modules where module_name='" + mn + "' and module_id!=" + 
          id;
